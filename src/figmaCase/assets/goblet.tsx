export const gobletIcon = (
  ...
  >
    <path
      id="Rectangle 25"
      opacity="0.5"
      d="M 31.675 17.111 C 25.375 10.811 29.837 0.04 38.746 0.04 L 75.315 0.04 C 84.224 0.04 88.685 10.811 82.386 17.111 L 64.102 35.395 C 60.196 39.3 53.865 39.3 49.959 35.395 L 31.675 17.111 Z"
      fill="#0369A1"
    />
